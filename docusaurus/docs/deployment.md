...
IMPORTANT: you need to set proper HTTP caching headers for `service-worker.js` file in `firebase.json` file or you will not be able to see changes after first deployment ([issue #2440](https://github.com/itgro/create-react-app/issues/2440)). It should be added inside `"hosting"` key like next:
